...
def get_train_args():
    ...
    parser.add_argument("--bert_model_name",type=str,required=True,help="bert model name",)
    parser.add_argument("--path_to_prompt_mapper",type=str,required=True,help="path to prompt mapper",)
    parser.add_argument("--path_to_train_data",type=str,required=True,help="path to train data",)
    parser.add_argument("--path_to_test_data",type=str,required=True,help="path to test data",)
    parser.add_argument("--path_to_save_model",type=str,required=True,help="path to save model",)
    ...
    parser.add_argument("--log_dir",type=str,required=False,default="runs/qaner",help="tensorboard log_dir",)
